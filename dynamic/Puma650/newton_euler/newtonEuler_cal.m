function [tao] = newtonEuler_cal(q,dq,ddq)
    ...
    R12 = hrotX3x3(-pi/2)*hrotZ3x3(qq2);          R21 = R12';
    R23 = hrotZ3x3(qq3-pi);                    R32 = R23';
    R34 = hrotX3x3(-pi/2)*hrotZ3x3(qq4);          R43 = R34';
    R45 = hrotX3x3(pi/2)*hrotZ3x3(qq5);           R54 = R45';
    R56 = hrotX3x3(-pi/2)*hrotZ3x3(qq6+pi);      R65 = R56';
